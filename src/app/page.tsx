...
const projects = [
  ...
  },
  {
    id: 3,
    title: "RAG Chatbot",
    subtitle: "Retrieval-Augmented Generation Assistant",
    description: "An intelligent chatbot that combines LLMs with a vector database to answer domain-specific questions. Features document ingestion, semantic search, and conversational memory for context-aware responses.",
    tags: ["Python", "LangChain", "OpenAI", "ChromaDB", "Streamlit", "RAG"],
    image: "",
  ...
  },
  {
    ...
    description: "A production-grade MLOps pipeline with automated training, model versioning, A/B testing, and monitoring. Includes CI/CD integration, drift detection, and real-time performance dashboards.",
    tags: ["Docker", "Kubernetes", "MLflow", "GitHub Actions", "Terraform", "Evidently"],
    image: "",
    github: "https://github.com/mariambenali",
    angle: 180
  },
  {
    ...
    description: "A responsive analytics dashboard built with Next.js for visualizing KPIs, tracking user behavior, and generating automated reports. Features real-time data streaming and interactive D3.js charts.",
    tags: ["Next.js", "TypeScript", "D3.js", "PostgreSQL", "REST API", "TailwindCSS"],
    image: "",
    github: "https://github.com/mariambenali",
    angle: 240
  },
  {
    ...
    subtitle: "Multi-Language Text Analysis Engine",
    description: "A sentiment analysis engine supporting French and English, powered by fine-tuned transformer models. Includes a FastAPI backend, batch processing capabilities, and an interactive Streamlit visualization layer.",
    tags: ["Python", "Hugging Face", "Transformers", "FastAPI", "Streamlit", "NLP"],
    image: "",
    github: "https://github.com/mariambenali",
    angle: 300
  }
